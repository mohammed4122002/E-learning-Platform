...
import { getCoursePage, type CoursePageView } from "@/lib/data/course-page";
...
function PrimaryAction({ course }: { course: CoursePageView }) {
...
export default async function CoursePage(props: PageProps<"/courses/[slug]">) {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-bg-page">
      ...
      <PublicBar subtitle={course.mode === "recorded" ? "دورة مسجَّلة" : mode.label === "حضورية" ? "دورة حضورية" : "دورة مباشرة عن بُعد"} />
