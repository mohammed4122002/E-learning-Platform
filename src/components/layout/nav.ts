...
export type NavItem = { label: string; href: string; icon: LucideIcon; badgeKey?: "pendingActions" };
...
export const TRAINEE_NAV: NavItem[] = [
  ...
  { label: "اكتشف دورة", href: "/trainee/discover", icon: Compass },
  { label: "ملف التدريب", href: "/trainee/trainings", icon: BookOpen },
...
export function isActive(pathname: string, href: string) {
  return href === "/trainee" ? pathname === "/trainee" : pathname === href || pathname.startsWith(`${href}/`);
}
