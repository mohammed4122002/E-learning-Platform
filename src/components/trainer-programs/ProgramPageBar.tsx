...
export function ProgramPageBar({ editHref, editLabel = "حرّر البرنامج", editDisabled, shareUrl, exitHref = "/trainer/programs" }: { editHref: string; editLabel?: string; editDisabled?: boolean; shareUrl?: string; exitHref?: string }) {
  return (
