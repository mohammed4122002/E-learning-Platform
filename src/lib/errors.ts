...
const MESSAGES: Record<string, string> = {
  ...
  // trainer bids & negotiation (TRR-BID-01…05)
  request_closed: "أُغلق باب العروض على هذا الطلب.",
  bid_program_not_published: "اختر برنامجًا منشورًا من برامجك — لا تُقدَّم العروض على مسودات.",
  bid_incomplete: "أكمل البرنامج والسعر وعدد الساعات وسبب ملاءمتك قبل الإرسال.",
  commitment_required: "أشّر على الالتزام بالتنفيذ في التواريخ المذكورة ليُرسَل العرض.",
  bid_exists: "قدّمت عرضًا على هذا الطلب من قبل — تابعه من «عروضي».",
  bid_not_withdrawable: "لا يمكن سحب هذا العرض في حالته الحالية.",
  bid_not_pending: "صدر قرار على هذا العرض بالفعل.",
  request_awarded: "اختارت الجهة مدربًا لهذا الطلب بالفعل.",
  bid_not_negotiable: "التفاوض متاح للعروض المقبولة التي لم يُتعاقد عليها بعد.",
  contract_window_over: "انتهت مهلة التعاقد على هذا العرض، فلا يمكن بدء التفاوض.",
  negotiation_used: "استُخدمت جولة التفاوض المتاحة لهذا العرض.",
  negotiation_closed: "انتهت هذه الجولة من التفاوض — حدّث الصفحة لرؤية حالتها.",
  negotiation_expired: "انقضت مهلة الرد على هذه الجولة وعادت الشروط الأصلية.",
  negotiation_empty: "عدّل شرطًا واحدًا على الأقل قبل الإرسال.",
  negotiation_no_change: "القيم المقترحة مطابقة للشروط الحالية — غيّر قيمة واحدة على الأقل.",
  negotiation_reason_required: "اكتب سببًا (٥ أحرف على الأقل) لكل شرط تقترح تعديله.",
  negotiation_final_round: "هذه الجولة الأخيرة — لا يمكن الرد عليها باقتراح مقابل.",
  invalid_term: "تحقّق من القيمة المقترحة لهذا الشرط.",
  invalid_term_dates: "تحقّق من التواريخ المقترحة: تبدأ من اليوم فصاعدًا وتنتهي بعد البداية.",
  term_locked: "هذا الشرط ثابت ولا يدخل في التفاوض.",
  term_not_proposed: "يمكن الرد فقط على الشروط التي اقترح المدرب تعديلها.",
};
