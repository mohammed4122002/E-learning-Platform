...
import {
  Banknote, Brain, Briefcase, Building2, CircleDot, Coins, Gauge, Layers, MapPin, Monitor, MonitorPlay, Palette, Route,
  Shield, Star, TrendingUp, Trophy, User, Users, Video,
} from "lucide-react";

/*
 * Enumerations of TRR-ONB-01 (copy from Figma 255:706 … 255:1010). Arrays are in the visual reading order of the
 * frames (right → left, row by row), so the first item renders at the inline start in RTL.
 */
export type TrainerOption = { value: string; title: string; hint?: string; icon: LucideIcon };

export const TRAINER_FIELDS: TrainerOption[] = [
  { value: "design", title: "التصميم والإبداع", icon: Palette },
  { value: "marketing", title: "التسويق والمبيعات", icon: TrendingUp },
  { value: "technology", title: "التقنية والبرمجة", icon: Monitor },
  { value: "management", title: "الإدارة والقيادة", icon: Briefcase },
  { value: "soft-skills", title: "المهارات الشخصية", icon: Brain },
  { value: "safety", title: "السلامة والجودة", icon: Shield },
  { value: "hr", title: "الموارد البشرية", icon: Users },
  { value: "finance", title: "المال والمحاسبة", icon: Coins },
];
...
export const EXPERIENCE_BANDS: TrainerOption[] = [
  ...
  { value: "2to5", title: "٢ – ٥ سنوات", hint: "خبرة متوسطة", icon: Gauge },
  { value: "lt2", title: "أقل من سنتين", hint: "بداية المسار", icon: CircleDot },
];

export const DELIVERY_MODES: TrainerOption[] = [
  { value: "recorded", title: "كورس مسجَّل جاهز", hint: "ترفعه وتبيعه — تسجيله يتم خارج المنصة", icon: MonitorPlay },
...
export const AUDIENCES: TrainerOption[] = [
  { value: "both", title: "كلاهما", hint: "أوسع فرصة للدخل", icon: Layers },
  { value: "organizations", title: "جهات تدريبية", hint: "أرتبط بجهة وتنفّذ دوراتي", icon: Building2 },
...
export const TRAINER_GOALS: TrainerOption[] = [
  { value: "full_time", title: "التفرّغ للتدريب", hint: "مصدر دخلي الأساسي", icon: Route },
  { value: "reputation", title: "بناء سمعة مهنية", hint: "ملف موثَّق وتقييمات", icon: Star },
  { value: "org_opportunities", title: "فرص مع الجهات", hint: "عقود تدريب مؤسسية", icon: Briefcase },
  { value: "extra_income", title: "دخل إضافي", hint: "من بيع برامجي", icon: Banknote },
];
